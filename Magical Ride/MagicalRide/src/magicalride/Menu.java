...
class Menu extends javax.swing.JFrame 
{
    ...
    boolean sliderIsOn = true;
    Clip clip;
    
    public Menu() 
    {
        initComponents();
        jPanel6.add(new JLabel(new ImageIcon("assets/bg/image3.jpg")));
        ...
        InputStream in = new FileInputStream(new File("assets/sound/sound44.mp3"));
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        String fileName = "G:/Case/MagicalRide/assets/score.txt";
